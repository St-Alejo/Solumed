...
export default function RecepcionPage() {
  ...
  const cargarArchivo = (f: File) => {
    if (!TIPOS.includes(f.type)) {
      toast("error", "Tipo no soportado. Usa PDF, PNG, JPG o TIFF"); return;
    }
      ...
      <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:20, marginBottom:20 }}>
        ...
        <div className="card card-p">
          ...
          <div
            ...
            <input ref={fileRef} type="file" accept=".pdf,.png,.jpg,.jpeg,.tiff,.webp"
            ...
            {archivo
              ...
              : <><CloudUpload size={28} color="var(--muted)" style={{ margin:"0 auto 8px" }}/>
                  ...
                  <p style={{ color:"var(--text4)", fontSize:12, marginTop:4 }}>PDF, PNG, JPG — máx. 10 MB</p></>
            }
          </div>
